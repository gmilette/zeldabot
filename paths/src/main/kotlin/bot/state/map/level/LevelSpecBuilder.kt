...
//            LevelSpec(getItemLoc4, e(u), "", LevelMapTemplateReader.Temp.lev_getitem, isGetItem = true),
    ...
    fun buildLevel6(): List<LevelSpec> {
        ...
        val specs = mutableListOf(
            ...
            LevelSpec(splitSpot, e(u, d), "split", LevelMapTemplateReader.Temp.lev_water_circle_path_up_down),
...
//        val first = start.left.up.up.up.up.up.left
        ...
        val specs = mutableListOf(
            ...
            // 97
            LevelSpec(second.left.left, e(u, d, r), "stair to near arrow", LevelMapTemplateReader.Temp.lev_stairs_center_blocked),
